        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div>
              <label className="flex items-start">
                ...
                <span className="ml-2 text-sm text-gray-600">
                  I agree to the{' '}
                  <Link to="/terms-conditions" className="text-primary hover:text-blue-900">
                    Terms & Conditions
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy-policy" className="text-primary hover:text-blue-900">
                    Privacy Policy
                  </Link>
                </span>
              </label>
          ...
          <div className="text-center">
            <p className="text-gray-600">
              ...
              <Link to="/login" className="text-primary hover:text-blue-900 transition-colors">
                Sign in
              </Link>
            </p>
          </div>
